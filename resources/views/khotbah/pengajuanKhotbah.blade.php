...
@section('main-content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Pengajuan Khotbah</h1>
        <a href="/khotbah/add" class="btn btn-success">Ajukan Khotbah Baru</a>
    </div>
                        ...
                        <tr>
                            ...
                            @if(\Illuminate\Support\Facades\Session::get('role') != '1' && \Illuminate\Support\Facades\Session::get('role') != '4' && $row -> status == '1')
                                <td style="white-space: nowrap">
                                    ...
                                    <a href="" class="btn btn-primary" data-toggle="modal" data-target="#uploadModal-{{$row->kotbah_id}}">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="/khotbah/delete/{{ $row->kotbah_id }}" class="btn btn-danger">Hapus</a>
                                    </div>
                                </div>
                            </div>
                        </div>

                        <div class="modal fade" id="uploadModal-{{$row->kotbah_id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                             aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Kirim Khotbah untuk di review?</h5>
                                        <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">×</span>
                                        </button>
                                    </div>
                                    <div class="modal-body">Apabila anda memilih upload, Khotbah tersebut tidak akan dapat diubah kembali.</div>
                                    <div class="modal-footer">
                                        <button class="btn btn-secondary" type="button" data-dismiss="modal">Batal</button>
                                        <a href="/khotbah/upload/{{$row->kotbah_id}}" class="btn btn-primary">Upload</a>
                                    </div>
                                </div>
                            </div>
                        </div>
