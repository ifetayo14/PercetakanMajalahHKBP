            ...
            <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    @foreach($dataKhotbah as $row)
                        ...
                        <div class="modal fade" id="deleteModal-{{$row->kotbah_id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="/khotbah/refuse/{{ $row->kotbah_id }}" class="user" method="post" enctype="multipart/form-data">
                                        @csrf
                        ...
                        <div class="modal fade" id="acceptModal-{{$row->kotbah_id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                             aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Terima Khotbah?</h5>
                                        <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">×</span>
                                        </button>
                                    </div>
                                    ...
                                    <div class="modal-footer">
                                        <button class="btn btn-secondary" type="button" data-dismiss="modal">Batal</button>
                                        <a href="/khotbah/accept/{{ $row->khotbah_id }}" class="btn btn-success">Terima</a>
                                    </div>
                                </div>
                            </div>
                        </div>
