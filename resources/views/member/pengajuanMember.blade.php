                ...
                <div class="col-lg-8">
                    <div class="p-5">
                        <div class="text-center">
                            <h1 class="h4 page-head-title mb-4">Pengajuan Membership</h1>
                        </div>
                        <form class="user" method="post" action="/member/reqMembership" enctype="multipart/form-data">
                            @csrf
