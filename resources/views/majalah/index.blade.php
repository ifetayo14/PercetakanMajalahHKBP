                    ...
                    <table style="width:100%" class="table table-striped" id="dataTable" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$p->judul}}</td>
                                <td>{{ $p->status}}</td>
                                <td><a href="/majalah/edit/{{$p->majalah_id}}" class="btn btn-outline-primary"><i class="fa fa-edit"></i> Edit</a><a href="/majalah/view/{{$p->majalah_id}}" class="btn btn-outline-warning"><i class="fa fa-eye"></i> View</a>
                                @if($p->status ==1)
