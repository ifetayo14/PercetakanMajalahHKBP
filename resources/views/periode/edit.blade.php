            ...
            <div class="col-12">
                <div class="p-5">
                    <div class="text-center">
                        <h1 class="h4 page-head-title mb-4">Ubah Periode</h1>
                    </div>
                    <form method="post" action="{{url('periode/edit/'.$periode[0]->periode_id)}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <textarea type="" name="deskripsi" class="form-control" id="deskripsi" placeholder="Deskripsi" style="height: 200px">{{$periode[0]->deskripsi}}
                                    </textarea>
                            </div>
                        </div> 
                        <div class="form-group row">
